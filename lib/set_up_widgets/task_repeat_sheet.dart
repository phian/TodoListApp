...
class TaskRepeatSheet extends StatefulWidget {
  ...
  TaskRepeatSheet({this.initChoiceData}) {
    repeatChoiceData = initChoiceData;
  }

  @override
  _TaskRepeatSheetState createState() => _TaskRepeatSheetState();
}

class _TaskRepeatSheetState extends State<TaskRepeatSheet> {
